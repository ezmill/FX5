...
function blackbox(el, sources, size, cbs) {
    ...
    addIcons();
    var soundFX = [];
    var backingTrack = new SoundEffect(PATH + "audio/backing.mp3", "backing", 0.25);
    var debounceResize;
...
        if (!createjs.Sound.initializeDefaultPlugins()) {return;}
    ...
    function onMouseUp() {
        ...
        //     createjs.Sound.stop(soundFX[effectIndex].id);
        // } else {
    ...
    function onWindowResize(event) {
        ...
        // if(marginLeft > window.innerWidth && !isMobile){
            // var newMargin = window.innerWidth - marginLeft;
            // if((marginLeft + newMargin <= 0)){
                // useMargin = true;
    ...
    function removeEventListeners(){
        ...
        document.removeEventListener('touchdown', onDocumentTouchStart, false);
