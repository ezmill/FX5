...
var GlitchShader4 = function(){
        ...
        this.fragmentShader = [
			...
			"	vec2 uv_nm = uv;",
			"	uv_nm = uv_nm+vec2(vt_rnd*0.25, 0);",
			"	uv_nm = sat( uv_nm + vec2(max_ofs_siz*vt_rnd, 0) );",
			...
			"    sample.r *= rand(vec2(uv_nm*sample.r));//*sat(vt_rnd - yuv_threshold);",
			"	sample.g *= rand(vec2(uv_nm*sample.g));//*sat(vt_rnd - yuv_threshold);",
			"	sample.b *= rand(vec2(uv_nm*sample.b));//*sat(vt_rnd - yuv_threshold);",
